...
document.addEventListener('submit',async e=>{
  ...
  if(e.target.id==='consent-form'){
    ...
    feedback('동의를 저장하고 14일 생활패턴 확인을 시작합니다.','success');await requestSelectedPermissions();await startRemoteMonitoring();queueInitialSignals();startPassiveCollectors();flushSignals();save();go('baseline');return;
  }
});
